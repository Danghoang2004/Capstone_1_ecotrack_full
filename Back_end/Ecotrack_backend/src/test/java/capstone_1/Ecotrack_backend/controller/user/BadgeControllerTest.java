...
class BadgeControllerTest {
    ...
    class GetAllBadges {
        ...
        void getAllBadges_returns200WithData() throws Exception {
            List<BadgeResponse> data = List.of(
                    new BadgeResponse(1L, "Starter", "/icon1.png", "Desc 1", "Req 1", 10, null, false),
                    new BadgeResponse(2L, "Hero", "/icon2.png", "Desc 2", "Req 2", 50, null, false)
            );
            ...
            mockMvc.perform(get("/api/user/badges/all")
                    ...
                    .andExpect(jsonPath("$.data[0].pointsRequired").value(10));
    ...
    class GetMyBadges {
        ...
        void getMyBadges_whenUserIdPresent_returns200WithData() throws Exception {
            Long userId = 10L;
            List<BadgeResponse> data = List.of(
                    new BadgeResponse(1L, "Starter", "/icon1.png", "Desc 1", "Req 1", 10, "2025-03-01T10:00:00", true),
                    new BadgeResponse(2L, "Hero", "/icon2.png", "Desc 2", "Req 2", 50, "2025-03-02T11:30:00", true)
            );
            ...
            mockMvc.perform(get("/api/user/badges/my")
                    ...
                    .andExpect(jsonPath("$.data[0].badgeName").value("Starter"))
                    .andExpect(jsonPath("$.data[0].pointsRequired").value(10))
                    .andExpect(jsonPath("$.data[0].isClaimed").value(true))
