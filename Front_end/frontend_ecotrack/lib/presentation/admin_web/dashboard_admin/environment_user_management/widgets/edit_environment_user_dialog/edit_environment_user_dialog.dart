...
class EditEnvironmentUserDialog extends StatefulWidget {
  final Map<String, dynamic> user;
  final VoidCallback onUpdated;

  const EditEnvironmentUserDialog({
    super.key,
    required this.user,
  ...
  @override
  State<EditEnvironmentUserDialog> createState() => _EditEnvironmentUserDialogState();
}

class _EditEnvironmentUserDialogState extends State<EditEnvironmentUserDialog> {
  ...
  Future<void> _handleSave() async {
    ...
    try {
      ...
      await _userService.updateEnvironmentUser(widget.user['id'] as int, updateData);
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Cập nhật tài khoản môi trường thành công'),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          const Text(
                            'Chỉnh sửa tài khoản môi trường',
                            style: TextStyle(
                              fontSize: 18,
                          ...
                          Text(
                            'Cập nhật thông tin nhân sự môi trường',
                            style: TextStyle(
                              fontSize: 13,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildTextField(
                        ...
                        validator: (v) =>
                            v == null || v.trim().isEmpty ? 'Vui lòng nhập tên đầy đủ' : null,
                      ),
                        ...
                        child: Row(
                          children: [
                            Icon(
                              ...
                              color: _isActive ? const Color(0xFF5EAC24) : Colors.grey[400],
                              size: 24,
                            ),
                            const SizedBox(width: 12),
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    _isActive
                                        ? 'Tài khoản có thể đăng nhập ứng dụng môi trường'
                                        : 'Tài khoản tạm khóa, không thể đăng nhập',
                                    style: TextStyle(fontSize: 12, color: Colors.grey[600]),
                                  ),
                                ],
                              ),
