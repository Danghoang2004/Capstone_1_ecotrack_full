...
class EnvironmentUserManagementController {
  ...
  bool get isAllSelected =>
      _filteredUsers.isNotEmpty && _selectedUserIds.length == _filteredUsers.length;
  ...
  Future<void> loadUsers() async {
    ...
    _error = null;
    try {
      final data = await _userService.getAllEnvironmentUsers();
  ...
  Future<void> deleteUser(int userId) async {
    try {
      await _userService.deleteEnvironmentUser(userId);
  ...
  Future<void> deleteSelectedUsers() async {
    ...
    try {
      ...
      await _userService.deleteEnvironmentUsers(userIds);
